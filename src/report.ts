...
export function renderPrComment(report: ImpactReport): string {
  const lines = [
    "## CodeGraph Impact",
    "",
    ...
    `CodeGraph: ${report.codegraph.available ? `available ${report.codegraph.version ?? ""}` : "not detected; using git diff heuristics"}`,
    "",
    "### Likely Symbols",
    ...
    "",
    "<sub>Generated by codegraph-impact.</sub>"
  ];
